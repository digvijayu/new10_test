      ...
      <div className="nt-home-page nt-ma-4">
        ...
        <div className="nt-row">
          <div className="nt-row-item nt-left-row-padding">
            <div><Text>target</Text></div>
            <div><Select/></div>
          </div>
          <div className="nt-row-item nt-right-row-padding">
            <div><Text>business.form</Text></div>
            <div><Select/></div>
          </div>
        </div>
        ...
        <div>
          <div className="nt-row">
            <div className="nt-row-item nt-left-row-padding"><Text>financing</Text></div>
            <div className="nt-row-item nt-right-row-padding"><Select/></div>
          </div>
          <div><RangeSelector/></div>
            <div className="nt-row">
              <div className="nt-row-item nt-left-row-padding"><Text>duration</Text></div>
              <div className="nt-row-item nt-right-row-padding"><Select/></div>
            </div>
          <div><RangeSelector/></div>
        </div>
        ...
        <div className="nt-row">
          <div className="nt-row-item">
            <a><Text>check.link</Text></a>
          </div>
          <div className="nt-row-item">
            <button><Text>check.link</Text></button>
          </div>
        </div>

        <div><Text>footer.description</Text></div>
      </div>
    );
  }
}
